...
const formSchema = z.object({
  ...
  value: z.string().min(4, {message: "O campo deve conter ao menos 4 caracteres" }).regex(/^#/, {
    message: "O valor deve ser um hexadecimal válido."
  })
});
...
export const ColorForm: React.FC<ColorFormProps> = ({
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error("Confira se você removeu todos os produtos desta cor.");
    } finally {
      setLoading(false);
      setOpen(false);
    }
